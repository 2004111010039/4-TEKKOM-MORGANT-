...
$sql="update tblusers set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email,ContactPerson=:contactperson";
          ...
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input class="form-control white_bg" name="contactperson" name="city" value="<?php echo htmlentities($result->contactperson);?>" id="contact-person" type="text" required>
            </div>
            <?php }} ?>
